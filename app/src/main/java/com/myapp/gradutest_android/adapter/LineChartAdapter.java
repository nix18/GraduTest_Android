...
import com.myapp.gradutest_android.utils.formatter.ClockInChartXFormatter;
...
public class LineChartAdapter {
    ...
    public LineChartAdapter(LineChart lineChart){
     ...
     * */
    public void setXAxis(boolean isEnable, boolean isgdl, float gdl, int xColor, XAxis.XAxisPosition xPosition, float xAngle, int xCount, String[] xLabels){
        ...
        ClockInChartXFormatter formatter = new ClockInChartXFormatter(xLabels);
